...
# Nesse código usamos a PipelineOptions que vem de um dicionário (PipelineOptions.from_dictionary, linha 16)#
# O preenchimento corresponde as informações da GCP #
# project - Id do projeto da GCP #
# runner - Runner  poque uso o Dataflow como ferramenta #
# region- regiao que escolhi na minha bucket # 
# temp_location - pego do path da GCP
# template_location - pego do path da GCP # curso-dataflow-beam-351817 
...
tabela = 'databigyquery.dataflow_voosatrasados'


# colocar o id da tabela.pego no bigquery lá em tabelas
...
tabela_atrasos = (
    ...
    | beam.io.WriteToBigQuery(
                              ...
                              custom_gcs_temp_location = 'gs://curso-apachebeam-bucket/Temp' )
